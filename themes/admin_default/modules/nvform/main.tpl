...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover table-middle">
        ...
        <tbody>
            <!-- BEGIN: row -->
            <tr>
                <td class="center"><select id="change_weight_{ROW.id}" onchange="nv_chang_weight('{ROW.id}', 0, 'form');" class="form-control">
                        <!-- BEGIN: weight -->
                ...
                <td><textarea rows="1" id="embed_copy" class="form-control" readonly="readonly" onfocus="this.select();" onmouseup="return false;">{ROW.embed_copy}</textarea></td>
                <td class="center"><select id="change_status_{ROW.id}" onchange="nv_chang_status('{ROW.id}', 'form');" class="form-control">
                        <!-- BEGIN: status -->
