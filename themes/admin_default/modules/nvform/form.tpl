	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-21">
					<input class="form-control" type="text" value="{DATA.alias}" name="alias" id="idalias" maxlength="255" />&nbsp;<em class="fa fa-refresh fa-lg icon-pointer" onclick="get_alias('{ID}');">&nbsp;</em>
				</div>
			</div>
			<div class="form-group">
